          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-slate-600 leading-relaxed">
                Founded in 2014, The Cancer Consciousness Initiative CCI was
                founded by like-minded progressive medical professionals worried
                about the rising cancer prevalence , mortality rates and huge
                cancer disparities faced by patients and survivors in the
                communities in the Northeast of Nigeria. What started as a state
                awareness campaign and screening program has grown to a regional
                movement.
              </p>
              <p className="text-slate-600 leading-relaxed">
                Over the years, we have partnered with local hospitals,
                international NGOs, and government bodies to raise awareness,
                screening services, and provide access to specialist oncology
                care patients in rural communities.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-slate-600">
              The passionate individuals leading the fight.
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-around gap-y-8">
            {[
              ...
              <motion.div
                ...
                className="group"
              >
                <div className="w-full sm:w-[250px] relative overflow-hidden rounded-2xl mb-4 aspect-[3/4]">
                  <img
                    src={member.img}
                    alt={member.name}
